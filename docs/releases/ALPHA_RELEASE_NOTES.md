...
We welcome contributions that align with our privacy-first mission! See [development/CONTRIBUTING.md](development/CONTRIBUTING.md) for guidelines.
...
- [design/DESIGN.md](design/DESIGN.md) - Architecture and philosophy
- [releases/CHANGELOG.md](CHANGELOG.md) - Version history
