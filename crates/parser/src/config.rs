...
impl Default for ParserConfig {
    fn default() -> Self {
        Self {
            ...
            max_css_size: 1024 * 1024, // 1MB default CSS size limit
        }
    }
}
...
impl ParserConfig {
    ...
    pub fn is_attribute_allowed(&self, attr_name: &str) -> bool {
        ...
        if attr_name.starts_with("on") || // Event handlers
           ...
           attr_name == "style"
        // Inline styles (potential CSS injection)
        {
            return false;
        }
        ...
        match self.security_level {
            ...
            SecurityLevel::Balanced => {
                ...
                !matches!(attr_name.as_str(), "javascript:" | "data:" | "vbscript:")
            }
            SecurityLevel::Custom => {
                // Use custom rules (to be implemented)
                true
