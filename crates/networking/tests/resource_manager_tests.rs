use citadel_networking::{
    CachePolicy, NetworkConfig, OriginType, PrivacyLevel, ResourceManager, ResourceManagerConfig,
    ResourcePolicy,
};
...
async fn test_policy_changes() {
    ...
    assert_eq!(
        manager.config.resource_policy,
