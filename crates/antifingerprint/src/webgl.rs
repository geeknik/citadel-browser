...
impl WebGLProtection {
    ...
    pub fn get_parameter_value(&self, param: WebGLParameter, domain: &str) -> Option<String> {
        ...
        // Emit privacy event
        self.manager
            .emit_neutralized(api_name, "spoofed value returned");
    ...
    pub fn normalize_vertices(
        ...
        // Emit privacy event
        self.manager
            .emit_neutralized("webgl.bufferData", "vertex noise injection");
...
mod tests {
    ...
    fn test_webgl_normalization() {
        ...
        assert!(normalized
            .extensions
            .contains(&"EXT_texture_filter_anisotropic".to_string()));
    }
    ...
    fn test_parameter_normalization() {
        ...
        let renderer = protection
            .get_parameter_value(WebGLParameter::Renderer, "example.com")
            .unwrap();
        assert_eq!(renderer, "NVIDIA GeForce RTX 3070");

        // Test vendor normalization
        let vendor = protection
            .get_parameter_value(WebGLParameter::Vendor, "example.com")
            .unwrap();
    ...
    fn test_shader_normalization() {
        ...
        assert_eq!(
            normalized,
            "precision mediump float; uniform mediump vec2 resolution;"
        );
    }
    ...
    fn test_vertex_normalization() {
        ...
        protection
            .normalize_vertices(&mut vertices, "example.com")
            .unwrap();
