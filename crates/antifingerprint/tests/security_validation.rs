...
mod security_validation_tests {
    ...
    fn test_canvas_fingerprinting_resistance() {
        ...
        for i in 0..10 {
            ...
            // Apply protection
            let protected = canvas_prot.protect_image_data(&data, "test.com");
            fingerprints.extend_from_slice(&protected);

            // Verify the data has been modified
            assert_ne!(data, protected, "Canvas data should be protected");
        }
        ...
        for (property, value) in test_properties {
            ...
            match property {
                "hardwareConcurrency" | "deviceMemory" => {
                    ...
                    assert_eq!(protected, "4" || protected == "8", "Hardware specs should be normalized");
                }
                "userAgent" => {
    ...
    fn test_fingerprinting_attack_simulation() {
        ...
        let protected_canvas = canvas_prot.protect_image_data(&canvas_data, attacker_domain);
        ...
        for i in 0..5 {
            ...
            let canvas = canvas_prot.protect_image_data(&canvas_data, &domain);
