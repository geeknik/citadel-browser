...
use citadel_antifingerprint::{
    apply_noise, apply_noise_f32, AntiFingerprintConfig, AntiFingerprintManager, AudioProtection,
    BrowserCategory, CanvasProtection, FingerprintManager, NavigatorInfo, NavigatorProtection,
    ProtectionLevel, ProtectionType, WebGLProtection,
};
use citadel_security::{FingerprintProtectionLevel, SecurityContext};
...
mod fingerprint_manager_tests {
    ...
    fn test_noise_application_randomness() {
        ...
        let all_same = values
            .iter()
            .all(|&v| (v - first_value).abs() < f64::EPSILON);
        assert!(
            !all_same,
            "All noise values were the same, indicating no randomness"
        );
    }
...
mod canvas_protection_tests {
    ...
    fn test_canvas_protection_creation() {
        ...
        assert!(protection
            .should_protect_operation(citadel_antifingerprint::CanvasOperation::TextRendering));
        assert!(protection
            .should_protect_operation(citadel_antifingerprint::CanvasOperation::ImageDrawing));
        assert!(protection
            .should_protect_operation(citadel_antifingerprint::CanvasOperation::GetImageData));
    }
    ...
    fn test_image_data_protection() {
        ...
        let result =
            protection.protect_image_data(&mut original_data, width, height, "example.com");
        assert!(result.is_ok());
        ...
        for i in (3..original_data.len()).step_by(4) {
            assert_eq!(
                original_data[i], original_copy[i],
    ...
    fn test_image_data_protection_deterministic() {
        ...
        protection
            .protect_image_data(&mut data1, width, height, "example.com")
            .unwrap();
        protection
            .protect_image_data(&mut data2, width, height, "example.com")
            .unwrap();

        assert_eq!(
            data1, data2,
            "Same domain should produce deterministic results"
        );
    }
    ...
    fn test_image_data_protection_domain_specific() {
        ...
        protection
            ...
            .unwrap();
        protection
            .protect_image_data(&mut data2, width, height, "different.com")
            .unwrap();
    ...
    fn test_canvas_protection_with_rng() {
        ...
        let result =
            protection.protect_image_data_with_rng(&mut data, width, height, "test.com", &mut rng);
        assert!(result.is_ok());
    ...
    fn test_canvas_operation_granular_control() {
        ...
        assert!(protection
            .should_protect_operation(citadel_antifingerprint::CanvasOperation::TextRendering));
        assert!(!protection
            .should_protect_operation(citadel_antifingerprint::CanvasOperation::ShapeRendering));
        assert!(protection
            .should_protect_operation(citadel_antifingerprint::CanvasOperation::ImageDrawing));
    }
}
...
mod navigator_protection_tests {
    ...
    fn test_navigator_normalization() {
        ...
        assert_ne!(
            ...
            real_navigator.hardware_concurrency
        );
    ...
    fn test_hardware_concurrency_awareness() {
        ...
        assert!(
            normalized.hardware_concurrency <= 16,
            "Hardware concurrency should be capped"
        );
        assert_eq!(
...
mod anti_fingerprint_manager_tests {
    ...
    fn test_metrics_integration() {
        ...
        manager.record_blocked(
            citadel_antifingerprint::ProtectionType::Canvas,
            "example.com",
        );
        manager.record_normalized(
...
mod noise_function_tests {
    ...
    fn test_global_apply_noise() {
        ...
        for value in values {
            ...
            assert!(
                deviation < original_value * 0.5,
                "Noise deviation too large: {}",
                deviation
            );
        }
    }
...
mod entropy_analysis_tests {
    ...
    fn test_canvas_entropy_reduction() {
        ...
        for _ in 0..10 {
            let mut data = create_test_canvas_data(width, height);
            protection
                .protect_image_data(&mut data, width, height, "example.com")
                .unwrap();
            datasets.push(data);
        }
        ...
        for dataset in &datasets[1..] {
            assert_eq!(
                ...
                "Canvas data should be deterministic for same domain"
            );
        }
        ...
        for i in 0..5 {
            ...
            protection
                .protect_image_data(&mut data, width, height, &domain)
                .unwrap();
...
mod attack_simulation_tests {
    ...
    fn test_fingerprintjs_canvas_attack_simulation() {
        ...
        // Apply protection
        let result = protection.protect_image_data(
            &mut canvas_data,
            width,
            height,
            "fingerprintjs-attacker.com",
        );
        assert!(result.is_ok());
        ...
        protection
            .protect_image_data(&mut session1_data, width, height, "attacker.com")
            .unwrap();
        protection
            .protect_image_data(&mut session2_data, width, height, "attacker.com")
            .unwrap();
    ...
    fn test_navigator_fingerprinting_attack_simulation() {
        ...
        assert_eq!(
            ...
            vec!["en-US".to_string(), "en".to_string(), "es".to_string()]
    ...
    fn test_cross_domain_fingerprinting_prevention() {
        ...
        for domain in &domains {
            ...
            protection
                .protect_image_data(&mut canvas_data, width, height, domain)
                .unwrap();
        ...
        for domain in &domains {
            ...
            protection
                .protect_image_data(&mut canvas_data1, width, height, domain)
                .unwrap();
            protection
                .protect_image_data(&mut canvas_data2, width, height, domain)
                .unwrap();

            assert_eq!(
                canvas_data1, canvas_data2,
                "Same domain should produce consistent fingerprints"
            );
        }
    }
    ...
    fn test_timing_attack_resistance() {
        ...
        let test_sizes = vec![(100, 100), (200, 200), (500, 500)];
        ...
        for (w, h) in test_sizes {
            ...
            let result =
                protection.protect_image_data(&mut canvas_data, w, h, "timing-attacker.com");
    ...
    fn test_sophisticated_canvas_tracking_prevention() {
        ...
        for (operation_type, x, y) in operations {
            ...
            assert_eq!(
                noisy_x, noisy_x2,
                "Position noise not deterministic for {}",
                operation_type
            );
            assert_eq!(
                noisy_y, noisy_y2,
...
mod metrics_tests {
    ...
    fn test_protection_metrics_tracking() {
        ...
        manager.record_blocked(
            citadel_antifingerprint::ProtectionType::WebGL,
            "example.com",
        );
        manager.record_normalized(
            citadel_antifingerprint::ProtectionType::Navigator,
    ...
    fn test_domain_statistics() {
        ...
        let canvas_count = stats
            .protection_counts
            .get(&ProtectionType::Canvas)
            .copied()
            .unwrap_or(0);
        let navigator_count = stats
            .protection_counts
            .get(&ProtectionType::Navigator)
            .copied()
            .unwrap_or(0);
...
mod performance_tests {
    ...
    #[test]
    #[ignore = "timing-sensitive micro-benchmark; flaky under CI/coverage instrumentation. Run with --ignored"]
    fn test_canvas_protection_performance() {
        ...
        let start = std::time::Instant::now();
        let result =
            protection.protect_image_data(&mut large_canvas, width, height, "performance-test.com");
        let duration = start.elapsed();
        ...
        for i in 0..100 {
            ...
            protection
                .protect_image_data(&mut small_canvas, small_width, small_height, &domain)
                .unwrap();
        }
        ...
        assert!(
            ...
            "Batch canvas protection too slow: {:?}",
            batch_duration
        );
    }
    ...
    fn test_navigator_protection_performance() {
        ...
        assert!(
            ua_duration.as_micros() < 500,
            "User agent normalization too slow: {:?}",
            ua_duration
        );
    }
    ...
    fn test_noise_function_performance() {
        ...
        assert!(
            f32_duration.as_millis() < 10,
            "F32 noise function too slow: {:?}",
            f32_duration
        );
    }
